...
- **SECTION_NAME** = [Human-readable name, e.g., "Who Am I?" or "My Toolbox"]
- **SECTION_ID** = [Folder name in sections/, e.g., "who-am-i" or "my-toolbox"]
- **NN** = [Milestone number, e.g., "02" or "03" — sections start at 02 since 01 is Foundation]

---

I need you to implement the **SECTION_NAME** section of my portfolio.
...
1. **Integration Points**
   ...
   - Any routing already set up?

2. **Customization**
   - Any changes to the provided content or layout?
